 ...
 *
 * Features:
 * - Bridge mint/burn for cross-chain WBTC deposits
    ...
    UUPSUpgradeable
{
    ...
    /// @param to Recipient
    /// @param amount Amount (8 decimals)
    ...
    /// @param publicAmount Amount (8 decimals)
     ...
     *      Rounding dust (up to 0.01 satoshi) is acceptable.
     * @param amount Amount of WBTC (8 decimals)
     */
