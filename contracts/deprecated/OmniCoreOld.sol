 ...
 * @notice [DEPRECATED] Non-upgradeable version - kept for reference only
 * @dev Replaces OmniCoinRegistry, OmniCoinConfig, ValidatorRegistry, OmniCoinAccount, and KYCMerkleVerifier
 * @custom:deprecated Use contracts/OmniCore.sol (upgradeable version) instead
 */
contract OmniCoreOld is AccessControl, ReentrancyGuard {
